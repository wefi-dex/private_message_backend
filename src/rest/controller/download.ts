...
export const downloadFileWithRange = asyncHandler(
  async (req: Request, res: Response) => {
    const { filename } = req.params
    ...
    const { stream, range: rangeInfo } = fileService.createFileStream(
      filename,
      range,
    )
...
export const downloadFileWithCustomName = asyncHandler(
  async (req: Request, res: Response) => {
    const { filename } = req.params
...
export const getFilesByDateRange = asyncHandler(
  async (req: Request, res: Response) => {
...
// Bulk delete files
export const bulkDeleteFiles = asyncHandler(
  async (req: Request, res: Response) => {
